...
### 🛠️ Skills  
- **Languages & Tools**: Python, R, SQL, Pandas, NumPy, Scikit-learn, PyTorch  
- **Visualization**: Tableau, Power BI, Looker, Excel  
- **Cloud & Big Data**: AWS, Azure, Snowflake, Spark, Airflow  
- **ML & AI**: Regression, Classification, NLP, Transformers, LLMs  
